...
extern int grid_editor_can_goto_definition(void);
extern int grid_editor_goto_definition(void);
extern int grid_editor_can_goto_definition_at(int row, int col);
extern int grid_editor_goto_definition_at(int row, int col);
